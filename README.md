...
3.Python ground station that reads serial data, parses gesture values, and maps them to flight commands

4.Dead-zone filtering, command clamping, and exponential smoothing for stable control

5.LiteWing ESP32‑S3 drone controlled over Wi‑Fi using Crazyflie setpoints

6.Safety: binary emergency stop (open hand), bounded commands, and fail‑safe zero thrust on comms loss
...
4.LDR with resistor divider for binary trigger detection
